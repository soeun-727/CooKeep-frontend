...
export default function ViewAllHeader({
    ...
    return (
        <div className="flex flex-shrink-0 flex-col items-center">
            {/* 검색창 */}
            <div
                className={`mt-12 !w-[361px] shadow-[0_4px_16px_-10px_rgba(0,0,0,0.25)] [&_input]:border-none [&_input]:focus:outline-none [&_input::placeholder]:text-gray-50 [&_p]:hidden ${
                    searchTerm
                        ? "[&_input]:bg-gray-0"
                        : "[&_input]:bg-searchbar"
                }`}
